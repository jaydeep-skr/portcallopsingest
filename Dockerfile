...
ENTRYPOINT ["java","-Dserver.port=8080", "-Dapp.sample.xml.payload=file:/home/AzureUser/portcallopsingest/xmldata/","-Dapp.keystore=/usr/local/openjdk-8/jre/lib/security/cacerts","dischargelistingest-0.0.1-SNAPSHOT.jar"]
