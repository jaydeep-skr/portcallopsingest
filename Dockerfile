...
ENTRYPOINT ["java","-jar", "-Dserver.port=8080", "-Dapp.sample.xml.payload=file:/home/AzureUser/portcallopsingest/xmldata/AMPS_discharge_as_XML_OMSLVTM_587_929W.xml","-Dapp.keystore=/usr/lib/jvm/java-1.8-openjdk/jre/lib/security/cacerts","dischargelistingest-0.0.1-SNAPSHOT.jar"]
